...
# Perspectives (preview) sample app template

[This article is pre-release documentation and is subject to change.]

In this tutorial, you'll learn about configuring and using the **Perspectives** sample app template.
...
For details about the above steps, visit the [installation guide](../../INSTALLATION.md).
...
![Perspectives main screen.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/Perspectives/Documentation/media/perspectives/perspectives-main-screen.png "Perspectives main screen")
...
6. Select an image or an icon. 
   ...
   ![Enter topic information.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/Perspectives/Documentation/media/perspectives/add-topic-screen.png "Add topic screen")
...
![Topic screen displaying discussions.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/Perspectives/Documentation/media/perspectives/discussion-screen.png "Discussion Screen")
...
5. Select **Save**.
    ...
    ![Screen to add a new discussion.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/Perspectives/Documentation/media/perspectives/begin-a-new-discussion.png "Begin a new discussion")
...
5. Select **Add a response.**
   ...
   ![The add a response button on the discussion screen.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/Perspectives/Documentation/media/perspectives/add-response-button.png "Add response button")
...
2. Right-click on Power Apps icon and select **Pop out app** to open the app in a new window. This pop-out action will ensure that you don't lose your changes if you navigate somewhere else in Teams.
   ...
   ![Power Apps main screen in Teams.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/Perspectives/Documentation/media/perspectives/power-apps-first-screen.png "Power Apps first screen")
...
5. In the Boards tile, select the **Perspectives** app to open it in Power Apps in Team.
   ...
   ![The Perspectives app in Power Apps.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/Perspectives/Documentation/media/perspectives/perspectives-tile.PNG)

6. You may get prompted to authorize the app's connectors to connect. Select **Allow**.

7. From here, you can customize the app. ![Perspectives app open in Power Apps studio.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/Perspectives/Documentation/media/perspectives/power-apps-screen.png "Power Apps Screen")

### See also

- [Understand Perspectives (preview) sample app template architecture](perspectives-architecture.md)
